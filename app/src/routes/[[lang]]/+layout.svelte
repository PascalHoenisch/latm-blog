...
<div class="flex flex-col h-screen">
    ...
    {#if !menuStatus}
        <div class="container px-3 flex-grow" id="body" in:fly={{ y:400, duration: 500 }} out:fly={{ y:400, duration: 400 }}>
            <slot/>
        </div>

        <div class="footer">
            <div class="bg-gray-200 pt-2 px-2 pb-2 grid grid-cols-2 gap-4">
                <div class="text-end">
